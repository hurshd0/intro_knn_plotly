...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.Img(src=app.get_asset_url('iris_petal_sepal.png'),
        ...
        html.A('Code on Github',
               href='https://github.com/austinlasseter/knn_iris_plotly'),
        html.Br(),
        html.A('Image/data source:',
               href='http://blog.kaggle.com/2015/04/22/scikit-learn-video-3-machine-learning-first-steps-with-the-iris-dataset/')
    ])
])
